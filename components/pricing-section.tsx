...
export function PricingSection() {
  ...
  const topRowPlans = [
    {
      ...
      features: [
        "25 Interactive Templates (All Demographic + 10 Methodology templates)",
        "Full template functionality with auto-save and progress tracking",
        "Mobile responsive access on all devices",
        "Basic PDF export with PlannerFlow branding",
    ...
    },
    {
      ...
      features: [
        "All 45+ Interactive Templates (Complete collection)",
        "Advanced template features with 100+ pre-populated dropdown options",
        "Enhanced PDF export with customization options",
        "Template progress tracking and completion analytics",
        "White-label PDF export (remove PlannerFlow branding)",
    ...
    },
    {
      ...
      features: [
        ...
        "Advanced template customization (colors, fonts, personal sections)",
        "Bulk template operations and batch processing",
        "Enhanced export formats (PDF, CSV, print-friendly)",
        "Early access to new templates (30 days before other tiers)",
        "Premium email support (12-hour response time)",
      ],
      buttonText: "Go Pro",
      buttonClass: "bg-red-600 hover:bg-red-700 text-white",
  ...
  const familyPlan = {
    ...
    savings: isYearly ? "save 30%" : null,
    description: "Comprehensive planning solution with multi-user access",
    features: [
      "Everything in Pro Plan",
      "Up to 6 family member accounts (separate logins and data)",
      "Shared family template access and planning tools",
      "Family progress dashboard and goal tracking",
      "Collaborative planning features for family goals",
      "Dedicated family support (priority assistance)",
    ],
            ...
            <Card className="bg-white border border-gray-200 shadow-sm">
              <CardContent className="p-4 sm:p-6">
                <div className="flex items-center justify-center gap-3 sm:gap-4">
                  <span className={`text-sm sm:text-base font-medium ${!isYearly ? "text-red-600" : "text-gray-500"}`}>
                    Monthly
                  </span>
                  <button
                  ...
                  <Badge className="bg-green-500 text-white ml-1 sm:ml-2 text-xs sm:text-sm">Save up to 30%</Badge>
                </div>
              </CardContent>
            </Card>
          </div>
